...
describe("crypto", () => {
  ...
  it("getAddressFromPrivateKey", () => {
    ...
    expect(address).toBe("omexchain1jjvpmgwwgs99nhlje3aag0lackunqgj7xnrnwe")
  ...
  it("getPrivateKeyFromKeyStore", () => {
    const keyStore = crypto.generateKeyStore(privateKey, "omexchain")
    const pk = crypto.getPrivateKeyFromKeyStore(keyStore, "omexchain")
  ...
  it("decodeAddressToBuffer", ()=>{
    let address = "omexchain1g7c3nvac7mjgn2m9mqllgat8wwd3aptddw77gw"
  ...
  it("bech32 and hex", () => {
    let bech32Address = "omexchain1g7c3nvac7mjgn2m9mqllgat8wwd3aptddw77gw"
